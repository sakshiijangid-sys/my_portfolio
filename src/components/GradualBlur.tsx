...
const DEFAULT_CONFIG: Required<Omit<GradualBlurProps, 'width' | 'preset' | 'className' | 'style' | 'hoverIntensity' | 'onAnimationComplete'>> = {
  position: 'bottom',
  strength: 2,
  height: '6rem',
  divCount: 5,
...
const useResponsiveDimension = (responsive?: boolean, config?: any, key?: string) => {
  ...
  return responsive ? value : config ? config[key!] : undefined;
};
